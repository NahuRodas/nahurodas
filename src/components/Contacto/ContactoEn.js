      ...
      <div className="contenedor-contacto">
        <div className="contacto">
          <form class="formulario" method='POST'>
            ...
            <input class="input-contacto " type="text" name="nombre" id="nombre" placeholder="Name. . . " required /><br />
            <input class="input-contacto " type="email" name="email" id="email" placeholder="Email. . . " required /><br />
            <textarea class="input-contacto " name="mensaje" id="mensaje" rows="10" autocapitalize="sentences" placeholder="Menssage. . . " maxlength="1000" required></textarea><br />
            <div className="div">
              <button class="btn-enviar" id="btn-enviar" type="submit" onClick={ enviarMensaje } >Send</button><br />
            </div>
          </form>
        </div>
        <div class="contacto">
